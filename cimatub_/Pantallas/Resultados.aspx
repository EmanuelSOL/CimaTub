<%@ Page Title="" Language="C#" MasterPageFile="~/MP/General.Master" AutoEventWireup="true" CodeBehind="Resultados.aspx.cs" Inherits="cimatub_.Pantallas.Resultados" %>
    ...
    <div class="container">
      <div class="header">
        <asp:Button ID="regresarBotonw" runat="server" CssClass="regresar-btn" Text="&lt; Regresar" OnClientClick="location.href='Inicio.aspx'; return false;" />
          <asp:Label ID="lblNFound" runat="server" CssClass="error"></asp:Label>
        <span class="textohistorial">Resultado de busqueda</span>
      </div>
      <div class="content">
