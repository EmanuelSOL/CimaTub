    ...
    <div class="main-content">
        ...
        <div class="register-container" id="agregar" runat="server">
            ...
            <div class="form-container">
                <asp:TextBox ID="tbRegCarrera" runat="server" placeholder="Nombre de la Carrera"></asp:TextBox>
            ...
            <div class="form-container" id="materiaContainer" runat="server">
                <asp:TextBox ID="tbRegMateria" runat="server" placeholder="Nombre de la Materia"></asp:TextBox>
                <asp:DropDownList ID="ddlCarreras" CssClass="carrerasss" runat="server">
